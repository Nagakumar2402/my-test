    ...
    <footer className="px-4 text-gray-100 bg-gray-800 divide-y">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="flex justify-center gap-4 md:justify-start">
          <div
            onClick={() => window.open("https://www.facebook.com/people/Zootopia-Funyard/pfbid02RW42Tr5AkqCbxcFNwxmQ229zwQcJcYFLZHvtswAgPesznF8ocFMLUyW7aLiMdPzBl/", "_blank")}
          ...
          <div 
          onClick={() => window.open("https://www.instagram.com/zootopia.funyard/", "_blank")}
          className="w-10 h-10 rounded-full bg-white/[0.25] flex items-center justify-center text-black hover:bg-white/[0.5] cursor-pointer">
            <FaInstagram size={20} />
          </div>
        </div>
