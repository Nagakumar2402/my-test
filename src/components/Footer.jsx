...
const FooterOne = () => {
  return (
    <footer className="px-4 text-[#636363] bg-[#F5EFE7] divide-y">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="text-gray-700 uppercase tracki">Categories</h3>
          ...
          <div className="space-y-3">
            <h3 className="text-gray-700 uppercase tracki">Company</h3>
            <ul className="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="#">
                  FAQ
          ...
          <div className="space-y-3">
            <div className="text-gray-700 uppercase">Social media</div>
