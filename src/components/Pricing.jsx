...
const Pricing = () => {
  return (
    <div className="w-full  px-10 py-5 mx-auto space-y-4 font-bold lg:px-20 lg:pt-10 ">
      ...
      <div className="grid items-center w-full max-w-full px-2  py-10 mx-auto space-y-4 md:grid-cols-2 md:gap-10 md:space-y-0 lg:grid-cols-3">
        {services1.map((service, i) => (
          ...
          <div className=" h-64 lg:h-[500px] overflow-hidden  w-full mx-auto  rounded-md flex items-center ">

            <img src={story} alt="" className="w-full h-full  aspect-[16/9] md:aspect-auto rounded-lg " />
          </div>
      <div className="grid items-center w-full max-w-full px-2 py-10 mx-auto space-y-4 md:grid-cols-2 md:gap-10 md:space-y-0 lg:grid-cols-3">
